...
# -*- coding: utf-8 -*-
#
# PyTPC documentation build configuration file, created by
...
# This appears in several places, so let's define it once here.
...
htmlhelp_basename = 'analysis-docs'
...
texinfo_documents = [
  ('index', project, docs_title,
   author, project, 'Analysis procedure for AT-TPC data.',
   'Miscellaneous'),
]
